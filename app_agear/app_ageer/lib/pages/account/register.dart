...
class _RegisterState extends State<Register> {
  ...
  bool _islistenLocation = false, _isGetLocatin = false;
  String title = "get locatin";
  ...
  saveDataCustomer(context, LoadingControl load) async {
    ...
    if (myvalid) {
      ...
      Map arr = {
        ...
        // "cus_latiute":_locationData.latitude,
        // "cus_latuite":_locationData.longitude,
      };
      ...
      if (isloading) {
        ...
        sh.setInt(G_cus_id, resArray["cus_id"]).toString();
        ...
        // sh.setDouble(G_cus_latiute, resArray["cus_latiute"]);
        // sh.setDouble(G_cus_latuite, resArray["cus_latuite"]);
