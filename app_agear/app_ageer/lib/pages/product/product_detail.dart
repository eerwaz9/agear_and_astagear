...
//=======================shopping cart
  ...
  void initState() {
    super.initState();
    myitem = new Item(
        ite_id: widget.food.foo_id.toString(),
        ite_name: widget.food.foo_name,
        ite_price: int.parse(widget.food.foo_price.toString()),
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        children: [
                          ...
                          new Text(
                            widget.food.foo_price.toString(),
                            style: TextStyle(
                                fontSize: 30.0,
                                fontFamily: "Arial",
                                color: Colors.orange),
                      ...
                      new Row(
                        children: <Widget>[
                          new Icon(Icons.favorite, color: Colors.orange),
                          new Text(
                            "5",
