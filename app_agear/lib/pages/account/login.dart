...
import 'package:app_agear/pages/account/forgetPassword.dart';
import 'package:app_agear/pages/account/register.dart';
  ...
  loginDataCustomer(context, LoadingControl load) async {
    ...
    if (myvalid) {
      ...
      if (isloading) {
        ...
        //عالجة خطاء هنا
        sh.setInt(G_cus_id, resArray["cus_id"]);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
       ...
       Consumer<LoadingControl>(builder: (context, load, child) {
                          ...
                          : MaterialButton(
                              onPressed: () {
                                loginDataCustomer(context, load);
                              },
                              child: Container(
