...
import 'dart:io';
  ...
  import 'package:app_agear/pages/food/food.dart';
import 'package:app_agear/pages/model/product/food_data.dart';
...
class _AddFoodState extends State<AddFood> {
  ...
  saveDataFood(context, LoadingControl load) async {
    ...
    if (myvalid) {
      ...
      Map<String,dynamic> resArray = await SaveDataList2  (_image,
    arr,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("اضافة سلعة للايجار جديدة "),
          centerTitle: true,
        ),
        body: Directionality(
