...
import '../model/product/add.dart';
import '../model/product/food_data.dart';
...
class _FoodState extends State<Food> {
  ...
  void _searchPressed(LoadingControl myProv) {
    if (this._searchIcon.icon == Icons.search) {
      ...
      this._appBarTitle = new Text("بحث باسم الشيء المراد اجارة");
    }
    myProv.add_loading();
  }
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Dismissible(
                      ...
                      onDismissed: (direction) {
                        ...
                        deleteData(
                            "foo_id", item.foo_id.toString(), "food/delete_food.php");
