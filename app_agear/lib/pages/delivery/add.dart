...
import 'package:app_agear/pages/delivery/delivery.dart';
...
class _AddDeliveryState extends State<AddDelivery> {
  ...
  TextEditingController txtdel_prac = new TextEditingController();
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                  hintText: "الاسم المؤجر", border: InputBorder.none),
                              validator: (String   value) {
                                if (value.isEmpty) {
                                  print("enyter name");
                                  return " الرجاء ادخال الاسم المؤجر";
                                }
                              },
                            ),
                          ),
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                  hintText: "سعر الأيجار",
                                  border: InputBorder.none),
                              validator: (String value) {
                                if (value.isEmpty) {
                                  return "الرجاء ادخال سعر الأيجار ";
                                }
                              },
                            ),
                          ),
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(25.0)),
                            child: TextFormField(
                              controller: txtdel_prac,
                              decoration: InputDecoration(
                                  hintText: "نوع الإيجار ", border: InputBorder.none),
                              validator: (String value) {
                                if (value.isEmpty) {
                                  print("enyter name");
                                  return "الرجاء ادخال نوع الإيجار ";
                                }
                              },
                            ),
                          ),
